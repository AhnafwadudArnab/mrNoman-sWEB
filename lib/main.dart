...
import 'Front-end/Provider/admin_theme_provider.dart';
import 'Front-end/Provider/notification_provider.dart';
import 'Front-end/Provider/api_ready_notifier.dart';
import 'Front-end/Provider/product_refresh_notifier.dart';
import 'Front-end/pages/Profiles/Wishlist_provider.dart';
import 'Front-end/utils/api_service.dart';
import 'Front-end/utils/auth_session.dart';
import 'Front-end/utils/scroll_to_top_observer.dart';
...
void main() async {
  ...
  // Disable google_fonts logging for web to prevent asset errors
