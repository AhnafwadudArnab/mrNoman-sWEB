...
import 'package:electrocitybd1/front_end/widgets/Sections/TechPart.dart';
import 'package:electrocitybd1/front_end/widgets/Sections/Trendings/TrendingItems.dart';
import 'package:electrocitybd1/front_end/widgets/Sidebar/sidebar.dart';
import 'package:electrocitybd1/front_end/widgets/footer.dart';
...
import '../widgets/Sections/Flash_Sale/flash_sale.dart';
...
class _MainContentState extends State<_MainContent> {
  ...
  void _startAutoSlide() {
    ...
    _autoSlideTimer = Timer.periodic(const Duration(seconds: 4), (_) {
      ...
      if (len < 2) return;
      final int next = ((_currentIndex + 1) % len).toInt();
