...
class _AdminCollectionsPageState extends State<AdminCollectionsPage> {
  ...
  void initState() {
    ...
    // Load collections automatically from DB on init
    _loadCollections();
  }
  ...
  Widget _buildHeader() {
    const brandPurple = Colors.black;
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [AdminTheme.surface, AdminTheme.surface],
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: brandPurple, width: 1),
            ),
            child: const Icon(
  ...
  Widget _buildUploadSection() {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(bottom: BorderSide(color: AdminTheme.brand, width: 2)),
      ),
      padding: const EdgeInsets.all(20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildCollectionsSection() {
    return Container(
      decoration: const BoxDecoration(color: AdminTheme.brand),
      padding: const EdgeInsets.all(20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                ...
                : SingleChildScrollView(
                    ...
                    child: Row(
                      children: List.generate(_collections.length, (index) {
                        ...
                        // Keep collection cards inside the admin palette.
                        final colors = [
                          AdminTheme.brand,
                          const Color(0xFF2C3947),
                           Colors.black,
                          const Color(0xFF547A95),
                        ];
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: AdminTheme.success.withOpacity(0.35),
                                  ),
                                ),
                                child: Text(
                                  'à§³${product['price'] ?? '0'}',
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: AdminTheme.error.withOpacity(0.12),
              shape: BoxShape.circle,
              border: Border.all(color: AdminTheme.error, width: 2),
            ),
            child: Icon(
