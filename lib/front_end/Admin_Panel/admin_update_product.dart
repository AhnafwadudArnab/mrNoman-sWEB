...
import 'package:electrocitybd1/front_end/utils/constants.dart';
...
class _AdminUpdateProductPageState extends State<AdminUpdateProductPage> {
  ...
  Future<void> _loadProductSections() async {
    try {
      ...
      // Extract Flash_Sale product IDs
      ...
      for (var product in _dbProducts) {
        ...
        if (flashSaleIds.contains(pid)) sections.add('Flash_Sale');
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    textAlign: TextAlign.center,
                    style: TextStyle(color: AdminTheme.textMuted, fontSize: 16),
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        isThreeLine: true,
        title: Text(name, style: TextStyle(color: AdminTheme.textSecondary)),
        subtitle: Column(
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          ...
          child: hasImageBytes && imageBytes != null
              ...
              : const Icon(Icons.image, color: AdminTheme.textMuted),
        ),
        title: Text(
          name,
