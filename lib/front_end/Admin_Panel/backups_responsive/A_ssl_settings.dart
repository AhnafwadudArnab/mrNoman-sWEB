...
class _AdminSslSettingsPageState extends State<AdminSslSettingsPage> {
  ...
  static const Color _brandOrange = Colors.black;
  ...
  Future<void> _saveAll() async {
    ...
    try {
      ...
      for (final e in entries.entries) {
        ...
        if (!mounted)
          return; // ✅ Check after each API call (critical for long loops)
      }

      if (!mounted) return;

      // ✅ Invalidate cache after all mutations
      ApiService.invalidateCache('/site_settings');
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(color: Colors.black),
                  filled: true,
                  fillColor: enabled ? _fieldBg : Colors.white,
                  isDense: true,
                  contentPadding: const EdgeInsets.symmetric(
                    horizontal: 12,
                    vertical: 10,
