...
class _AdminDealsTimerPageState extends State<AdminDealsTimerPage> {
  ...
  static const _orange = Color(0xFF4D6787);
    ...
    showDialog(
      ...
      builder: (dialogCtx) => StatefulBuilder(
        builder: (dialogCtx, setS) => AlertDialog(
          ...
          title: const Text('Add Timer', style: TextStyle(color: Colors.black)),
  ...
  Widget _emptyState() => Center(
    child: Column(
      ...
      children: [
        Icon(Icons.timer_outlined, size: 72, color: Colors.black),
        const SizedBox(height: 16),
        const Text(
          'No timers yet',
          style: TextStyle(
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 48,
              decoration: BoxDecoration(
                color: isActive ? _orange : Colors.black,
                borderRadius: BorderRadius.circular(10),
