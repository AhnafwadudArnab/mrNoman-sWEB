...
class AdminTheme {
  ...
  static BoxDecoration cardDecoration({
    ...
    border: Border.all(
      color: highlighted ? brand.withOpacity(0.6) : border.withOpacity(0.6),
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        disabledBackgroundColor: AdminTheme.brand.withOpacity(0.5),
        ...
        elevation: 2,
        shadowColor: AdminTheme.brand.withOpacity(0.4),
      ),
      child: loading
          ? const SizedBox(
              width: 18,
