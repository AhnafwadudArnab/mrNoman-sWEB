    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: isSelected ? const Color(0xFF2E7D32) : AppColors.grey200,
            width: isSelected ? 1.6 : 1,
          ),
        ),
        child: Row(
  ...
  Widget _trustItem(IconData icon, String label) {
    return Row(
      ...
      children: [
        ...
        Text(label, style: TextStyle(fontSize: 12, color: AppColors.grey300)),
      ],
    );
  }
  ...
  Widget _qtyBtn({required IconData icon, required VoidCallback onTap}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon, size: 12, color: AppColors.grey300),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.5,
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: AppColors.grey300),
          onPressed: () => Navigator.pop(context),
        ),
        title: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
