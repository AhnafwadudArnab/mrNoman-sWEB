...
class _SearchBarWidgetState extends State<SearchBarWidget> {
  ...
  Widget _buildSectionHeader(String title, IconData icon) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, size: 16, color: AppColors.grey300),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            const Icon(Icons.north_west, size: 16, color: AppColors.grey300),
          ],
        ),
      ),
    );
  ...
  Widget _buildHistoryItem(Map<String, dynamic> item) {
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            const Icon(Icons.history, size: 20, color: AppColors.grey300),
            const SizedBox(width: 12),
            Expanded(
              child: Text(
                item['search_query'],
    ...
    return CompositedTransformTarget(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: const Icon(Icons.search, color: AppColors.grey300),
          suffixIcon: _controller.text.isNotEmpty
              ? IconButton(
                  icon: const Icon(Icons.clear, color: AppColors.grey300),
