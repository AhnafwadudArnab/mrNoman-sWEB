...
class _SidebarState extends State<Sidebar> {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ?? SERVICE ASSURANCES (dark grey block)
            _buildTrustSection(),
  ...
  Widget _buildCategoryList(BuildContext context) {
    ...
    final Map<String, Map<String, dynamic>> categoryByName = {
      for (final c in _categories) (c['category_name']?.toString() ?? ''): c,
    };
    ...
    final List<Map<String, dynamic>> orphans = _categories.where((c) {
    ...
    return Container(
      ...
      child: Column(
        children: orderedCategories.asMap().entries.map((entry) {
          ...
          final childNames = isParent
              ? (_parentChildMap[categoryName] ?? [])
              : <String>[];
          ...
          return Column(
            children: [
              ...
              if (isParent && isParentExpanded && childCategories.isNotEmpty)
                ...childCategories.map(
                  (child) => _buildChildCategoryRow(context, child),
                ),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  height: 14,
                  decoration: BoxDecoration(
                    color: AppColors.blueGreyShade300,
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [AppColors.error, AppColors.redShade900],
            ),
  ...
  Widget _trustItem(IconData icon, String label) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, color: AppColors.amberShade700, size: 20),
          const SizedBox(width: 12),
          Text(
            label,
            style: const TextStyle(
