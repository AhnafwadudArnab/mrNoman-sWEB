...
class _DealsOfTheDayState extends State<DealsOfTheDay> {
  ...
  Future<void> _loadTimerFromApi({bool silent = false}) async {
    try {
      ...
      debugPrint('?? Timer load failed: $e');
      _useDefaultTimer(silent: silent);
    }
  }
  ...
  ProductData _buildProductDataFromDb(Map<String, dynamic> p, int index) {
    ...
    return ProductData(
      ...
      additionalInfo: {
        'Brand': p['brand_name'] ?? '',
        'Old Price': 'Tk ${oldPrice.toStringAsFixed(0)}',
              ...
              Center(
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      _timerUnit(twoDigits(days), 'D'),
                      const SizedBox(width: 8),
                      _timerUnit(twoDigits(hours), 'H'),
                      const SizedBox(width: 8),
                      _timerUnit(twoDigits(minutes), 'M'),
                      const SizedBox(width: 8),
                      _timerUnit(twoDigits(seconds), 'S'),
                    ],
                  ),
                ),
              )
                        ...
                        for (var i = 0; i < _dbDeals.length; i++) {
                          ...
                          cards.add(
                            _productCard(
                              ...
                              price: 'Tk ${dealPrice.toStringAsFixed(0)}',
                              oldPrice: 'Tk ${priceVal.toStringAsFixed(0)}',
                              imagePath: '',
                        ...
                        for (var i = 0; i < adminDeals.length; i++) {
                          ...
                          cards.add(
                            _productCard(
                              ...
                              title: p['name'] ?? '',
                              price: 'Tk ${priceVal.toStringAsFixed(0)}',
                              oldPrice: 'Tk ${oldPriceVal.toStringAsFixed(0)}',
                              imagePath: '',
                              onTap: () => _openDetails(productData),
              ...
              child: isTimerActive
                  ? Row(
                      ...
                      children: [
                        ...
                        _timerUnit(hours, 'H'),
                        const SizedBox(width: 4),
                        _timerUnit(minutes, 'M'),
                        const SizedBox(width: 4),
                        _timerUnit(seconds, 'S'),
                      ],
                    )
                  : const Text(
                      'Offer Ended',
  ...
  static Widget _timerUnit(String value, String label) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(
