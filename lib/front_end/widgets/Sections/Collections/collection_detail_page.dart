...
class _CollectionDetailPageState extends State<CollectionDetailPage> {
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: selected
                  ...
                  : const Color(0x0A212121),
              border: Border.all(
                color: selected ? Colors.red.shade300 : AppColors.grey200,
                width: selected ? 2 : 1,
              ),
              borderRadius: BorderRadius.circular(12),
              boxShadow: selected
              ...
              children: [
                IconButton(
                  ...
                  onPressed: _currentPage > 1
                      ...
                      : null,
                  color: _currentPage > 1 ? Colors.black87 : Colors.black26,
                ),
                if (_totalPages <= 7) ...[
  ...
  Widget _buildSortPill() {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(color: Colors.black26 ?? Colors.black87),
                  ...
                  Row(
                    children: List.generate(
                      ...
                      (i) => Icon(
                        Icons.star,
                        size: 12,
                        color: i < 4 ? Colors.orange : Colors.black26,
                      ),
                    ),
                  ),
                  const SizedBox(height: 8),
