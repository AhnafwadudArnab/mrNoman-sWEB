...
class ApiService {
  ...
  /// Only applies to endpoints that are known to cause redirects (product-related)
  static String _ensureTrailingSlash(String endpoint) {
    // Only fix endpoints that Apache redirects (no trailing slash before query)
    final qIdx = endpoint.indexOf('?');
  ...
  static Future<void> createFlashSale(Map<String, dynamic> data) async {
    ...
    invalidateCache('/products'); // flash sale products cached under /products
