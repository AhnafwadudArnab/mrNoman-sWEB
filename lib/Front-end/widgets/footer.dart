            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    const Color(0xFFFAB12F).withValues(alpha: 0.9),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xFFFAB12F).withValues(alpha: 0.08),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: const Color(0xFFFAB12F).withValues(alpha: 0.3),
                        width: 2,
                      ),
                    ),
                    child: Row(
      ...
      child: Column(
        ...
        children: [
          Container(
            padding: const EdgeInsets.all(8),
            decoration: BoxDecoration(
              color: const Color(0xFFFAB12F).withValues(alpha: 0.1),
              borderRadius: BorderRadius.circular(8),
            ),
