...
class _AdminPaymentsPageState extends State<AdminPaymentsPage> {
  ...
  Widget _methodCard(Map<String, dynamic> method) {
    ...
    final leading = Container(
      ...
      height: 46,
      decoration: BoxDecoration(
        color: isEnabled ? _brandOrange.withOpacity(0.16) : _fieldBg,
        borderRadius: BorderRadius.circular(8),
      ),
      child: Icon(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: isEnabled ? _brandOrange.withOpacity(0.4) : Color(0x0D000000),
        ),
      ),
      child: LayoutBuilder(
        builder: (context, constraints) {
      ...
      child: Column(
        children: [
          ...
          const Text(
            ...
            style: TextStyle(color: AdminTheme.textPrimary, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 10),
          ElevatedButton.icon(
            onPressed: () => _showAddEditDialog(),
  ...
  Widget _pill(String text, {Color color = Colors.white60}) {
    return Container(
  ...
  InputDecoration _fieldDecoration({
    ...
    return InputDecoration(
      ...
      prefixIcon: Icon(icon, color: Color(0x73000000), size: 18),
      filled: true,
      fillColor: _fieldBg,
