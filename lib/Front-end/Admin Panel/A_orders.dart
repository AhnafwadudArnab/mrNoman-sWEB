                    ...
                    return Column(
                      ...
                      children: [
                        InkWell(
                          ...
                          child: isMobile
                              ? _buildMobileRow(order)
                              : _buildDesktopRow(order, ordersProvider),
                        ),
...
<body>
  <main class="memo">
    ...
    <p class="note">This memo was generated from the ElectroZoneBD admin panel. Please keep it with the delivery parcel and customer order record.</p>
  </main>
</body>
</html>
''';
