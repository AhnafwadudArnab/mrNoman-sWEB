  ...
  Widget _sectionCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _brandOrange.withOpacity(0.3), width: 2),
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          Divider(color: _brandOrange.withOpacity(0.2), height: 1),
          const SizedBox(height: 16),
          ...children,
        ],
      ),
  ...
  Widget _gridField(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: _brandOrange.withOpacity(0.25), width: 1),
        boxShadow: [
          BoxShadow(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
                borderSide: BorderSide(color: _brandOrange.withOpacity(0.2)),
              ),
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
