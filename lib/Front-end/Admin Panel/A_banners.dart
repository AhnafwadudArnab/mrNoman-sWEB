              ...
              Wrap(
                ...
                children: [
                  ...
                  TextButton.icon(
                    ...
                    icon: const Icon(Icons.add, color: AdminTheme.textPrimary, size: 18),
          ...
          child: Column(
            ...
            children: [
              Wrap(
                ...
                children: [
                  const Text(
                    "Mid Banners (Dynamic list below Flash Sale)",
                    style: TextStyle(
                      color: AdminTheme.textPrimary,
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
              ...
              const SizedBox(height: 8),
               Text(
                ...
                style: TextStyle(color: Color(0x73000000), fontSize: 13),
              ),
              const SizedBox(height: 16),
