        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                color: isActive ? cardColor : cardColor.withValues(alpha: 0.3),
                width: isActive ? 2.5 : 1.5,
              ),
              boxShadow: [
                BoxShadow(
                  color: cardColor.withValues(alpha: isActive ? 0.25 : 0.08),
                  blurRadius: 12,
                  offset: const Offset(0, 4),
                ),
              ],
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: cardColor.withValues(alpha: isActive ? 0.4 : 0.15),
                    ),
                  ),
