...
async function main() {
  ...
  ws.onopen = async () => {
    ...
    console.log('2. Clicking Admin on storefront...');
    await clickAt(1450, 38);
    await wait(3000);

    console.log('3. Scrolling down to Feature / Trust Badges editor...');
    for (let k = 0; k < 6; k++) {
    ...
    console.log('Saved admin_trust_badges_editor_live.png');
