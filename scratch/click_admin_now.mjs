...
async function main() {
  ...
  ws.onopen = async () => {
    ...
    console.log('1. Clicking Admin in header at (1420, 38)...');
    await click(1420, 38, 2000);
    await shot('check_admin_clicked.png');

    console.log('2. Scrolling sidebar down to reveal Banners...');
    await scroll(80, 400, 500, 1000);

    console.log('3. Clicking Banners at (80, 585)...');
    await click(80, 585, 2000);

    console.log('4. Scrolling right content down to Feature / Trust Badges editor...');
    await scroll(600, 400, 2200, 1500);

    console.log('5. Taking screenshot of Trust Badges Editor...');
