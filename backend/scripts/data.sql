...
(21, 'Cat-Ear Pocket Handheld Fan',        'Cute rechargeable pocket handheld mini fan with multi-speed airflow and USB charging.',                         2500, 35,  'assets/prod/hFan3.jpg',          4,  6),
(22, 'Hamilton Rechargeable Table Fan',   'Hamilton 8-inch rechargeable table fan with bright emergency LED light and multi-speed settings.',              1800, 60,  'assets/prod/fan2.jpg',           4,  10),
(23, 'YiLFo Professional Cordless Trimmer', 'Professional cordless hair clipper and beard trimmer kit with precision guide combs and rechargeable battery.', 1400, 50,  'assets/prod/trimmeer2.jpg',      3,  9),
(24, 'Vintage Rotary Dial Telephone Set',  'Classic retro vintage rotary dial corded landline telephone set for home and office decor.',                    900, 75,  'assets/prod/tele_sett.jpg',      6,  3),
(25, 'Digital Window Air Fryer 6L',       'Large 6L digital air fryer with clear viewing window, touch screen controls, and 8 preset cooking modes.',       1100, 65,  'assets/prod/catllee.jpg',        10, 2),
(26, 'Portable Mini Fan with Display',     'Compact rechargeable pocket handheld fan with digital battery percentage display and foldable lanyard.',        800, 80,  'assets/prod/minihand.jpg',       4,  1),
