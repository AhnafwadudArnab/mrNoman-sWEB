...
(10, 4, 3, 'Hikvision Turbo HD CCTV Surveillance Kit', 'High-definition 8-camera surveillance kit with Turbo HD DVR, night vision, weatherproof cameras, and remote viewing capabilities.', 8500.00, 12, 'assets/prod/2.png', NULL, '2026-03-01 07:11:36', 5, 1000),
...
(12, 1, 1, 'Haeger Stainless Steel Rice Cooker & Steamer 5L', 'Large 5L stainless steel electric rice cooker with keep-warm function, non-stick inner pot, and vegetable steaming basket.', 8500.00, 10, 'assets/prod/rice_cooker.jpg', NULL, '2026-03-01 07:11:36', 5, 1000),
(13, 3, 2, 'Hamilton 8" Rechargeable Table Fan with LED Light', 'Compact 8-inch rechargeable table fan with bright LED light, multi-speed airflow, and long-lasting backup battery for power outages.', 4200.00, 25, 'assets/prod/fan2.jpg', NULL, '2026-03-01 07:11:36', 5, 1000),
(14, 3, 2, 'Walton 1.5 Ton Inverter Air Conditioner', 'Energy-efficient 1.5 ton split air conditioner with ProGen inverter technology, fast cooling, auto-restart, and sleep mode.', 32200.00, 8, 'assets/prod/6.png', NULL, '2026-03-01 07:11:36', 5, 1000),
(15, 1, 2, 'Jamuna Electric Rice Cooker 2.8L with Steamer', 'High quality Jamuna royal blue electric rice cooker 2.8L with stainless steel steamer tray, extra inner pot, and 1-year warranty.', 46500.00, 5, 'assets/prod/3.png', NULL, '2026-03-01 07:11:36', 5, 1000),
(16, 1, 1, 'Stainless Steel Electric Spice & Coffee Grinder', 'Multi-purpose stainless steel electric spice and coffee grinder with push-down safety lid and sharp stainless steel blades.', 2800.00, 20, 'assets/prod/grinder.jpg', NULL, '2026-03-01 07:11:36', 5, 1000),
(17, 1, 3, 'Nova 3-in-1 Blender Mixer & Grinder 870W', 'High-power 870W copper motor with 3 heavy-duty stainless steel jars for multi-purpose blending, wet grinding, and dry spice grinding.', 18500.00, 7, 'assets/prod/4.jpg', NULL, '2026-03-01 07:11:36', 5, 1000),
...
(19, 3, 4, 'Mini Handheld Cat-Ear Portable Fan', 'Adorable cat-ear rechargeable pocket fan with quiet multi-speed airflow, ergonomic handle, and USB charging.', 2200.00, 20, 'assets/prod/hFan3.jpg', NULL, '2026-03-01 07:11:36', 5, 1000),
...
(21, 3, 6, 'Cat-Ear Cute Rechargeable Handheld Pocket Fan', 'Ultra-portable pocket fan with cute cat ears, USB rechargeable battery, and smooth quiet breeze.', 2500.00, 35, 'assets/prod/hFan3.jpg', NULL, '2026-04-14 08:08:31', 5, 1000),
(22, 3, 10, 'Hamilton 8" Rechargeable Table Fan HT-7092', 'High quality Hamilton 8-inch rechargeable desk fan with emergency LED light, dual power options, and long-lasting backup.', 1800.00, 60, 'assets/prod/fan2.jpg', NULL, '2026-04-14 08:08:31', 5, 1000),
(23, 2, 9, 'YiLFo Professional Cordless Hair Clipper & Trimmer Kit', 'Professional cordless hair cutting and detail trimming grooming kit with guide combs, barber shears, and rechargeable battery.', 1400.00, 50, 'assets/prod/trimmeer2.jpg', NULL, '2026-04-14 08:08:31', 5, 1000),
(24, 4, 3, 'Pyle Vintage Classic Rotary Dial Telephone Set', 'Classic retro rotary dial landline telephone in glossy black finish with coiled handset cord and authentic bell ringer.', 900.00, 75, 'assets/prod/tele_sett.jpg', NULL, '2026-04-14 08:08:31', 5, 1000),
(25, 1, 5, 'Panasonic 6L Digital Air Fryer with Viewing Window', 'Crispy, juicy, healthy cooking with 6L large capacity, transparent viewing window, gentle steam technology, and 360-degree airflow.', 18000.00, 14, 'assets/prod/09.png', NULL, '2026-03-01 07:11:36', 5, 1000),
(26, 3, 1, 'Portable Handheld Mini Fan with Digital Display', 'Pocket handheld rechargeable mini fan with LED battery percentage display, folding head, and neck lanyard.', 800.00, 80, 'assets/prod/minihand.jpg', NULL, '2026-04-14 08:08:31', 5, 1000),
(27, 1, 2, 'Prestige Delight Electric Rice Cooker 1.8L', 'Prestige Delight cyan blue electric rice cooker 1.8L with non-stick cooking bowl, keep-warm feature, and glass lid.', 3200.00, 25, 'assets/BestSale/prestige.jpg', NULL, '2026-04-14 08:08:31', 5, 1000),
...
(45, 3, 3, 'Nova Rechargeable Table Fan with Emergency Light', 'Nova multi-speed rechargeable table fan with 5 aerodynamic pink blades, emergency LED night light, and USB mobile phone charging output.', 1200.00, 30, 'assets/prod/5.jpg', NULL, '2026-03-01 07:11:55', 5, 1000),
...
(53, 3, 7, 'JY-1880 Rechargeable Mini Desk Fan', 'JY-1880 compact portable rechargeable desk fan with yellow spiral safety grill, two speed settings, and USB charging.', 3200.00, 30, 'assets/flash/jy mini 1880.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
...
(55, 3, 3, 'LR-2018 Telescopic Foldable Rechargeable Fan', 'Telescopic height-adjustable foldable desk fan LR-2018 with built-in LED night lamp and long-lasting rechargeable battery.', 4500.00, 24, 'assets/flash/lr2018.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(56, 1, 6, 'Miyako Electric Curry Cooker 5.5L', 'Miyako 5.5L multi-purpose electric curry cooker with glass lid, non-stick cooking pot, and automatic heat control.', 1650.00, 75, 'assets/trends/miyoko.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
...
(58, 1, 9, 'Miyako Pink Panther Mixer Grinder 750W', 'Miyako Pink Panther 750W copper motor mixer grinder with stainless steel jars, pulse control, and overload protection.', 2300.00, 60, 'assets/trends/pink.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
...
(61, 3, 7, 'Joykaly YG-717 Mini Rechargeable LED Fan', 'Joykaly YG-717 mini rechargeable folding desk fan with 2400mAh battery, 8-10 hour backup, and built-in night light.', 2900.00, 35, 'assets/flash/yg mini 717.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(62, 1, 1, 'Star Track Multi-Function Air Fryer', 'Star Track mechanical multi-function air fryer with dual rotary dials for temperature and timer control.', 7200.00, 40, 'assets/trends/air_fryer.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(63, 1, 9, 'Sonifer Electric Sandwich & Panini Grill Maker 750W', 'Sonifer compact 750W non-stick electric sandwich and panini press grill with automatic thermostat and cool-touch handle.', 3200.00, 35, 'assets/trends/av.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
...
(65, 1, 6, 'Chefman Electric Glass Kettle with Infuser 1.8L', 'Chefman premium 1.8L borosilicate glass electric kettle with stainless steel tea infuser and auto-shutoff protection.', 1750.00, 80, 'assets/trends/catllee.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(66, 3, 4, 'Solar Powered Rechargeable Desk Fan with Solar Panel', 'Solar powered rechargeable desk fan with external photovoltaic solar panel, dual LED bulbs, and USB output.', 2200.00, 70, 'assets/trends/chargerfan.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(67, 1, 10, 'V-Guard Electric Induction Cooktop 1800W', 'V-Guard 1800W high-speed induction cooktop with 7 cooking power levels, auto-off timer, and overheat protection.', 1250.00, 55, 'assets/trends/elec_stove.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(68, 1, 3, 'Sensio Home 3-in-1 Hand Blender & Whisk', 'Sensio Home stainless steel immersion stick blender with ergonomic grip, balloon whisk, and variable speed settings.', 2800.00, 50, 'assets/trends/hand_blender.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(69, 2, 5, 'Electric Octopus Head & Scalp Massager', 'Hands-free octopus-claw electric vibration scalp massager for stress relief, headache soothing, and hair stimulation.', 3800.00, 30, 'assets/trends/head_massager.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
...
(71, 1, 7, 'Smart Mini Electric Multi Cooker with Digital Preset', 'Compact digital electric multi cooker with carrying handle, preset cooking programs for rice, soup, porridge, and stew.', 2500.00, 40, 'assets/trends/mini_cooker.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(72, 1, 7, 'Multi-Function Electric Hot Pot Cooker 1.5L', 'Electric ramen and noodle hot pot with wooden anti-scald handle, non-stick inner coating, and dry-burn protection.', 3100.00, 35, 'assets/trends/mini2cokker.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(73, 3, 2, 'Portable Handheld Mini Fan with Digital Display', 'Compact pocket rechargeable handheld fan with LED battery percentage display, foldable stand, and lanyard.', 1900.00, 55, 'assets/trends/minihand.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
...
(75, 1, 10, 'Noha Super Magic Blender & Mixer Grinder 1050W', 'Noha Super Magic 1050W heavy-duty copper motor blender with 3 stainless steel jars, durable blades, and 1-year warranty.', 4200.00, 30, 'assets/trends/noha_hot_king.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(76, 1, 2, 'Haeger Stainless Steel Rice Cooker & Steamer 1.8L', 'Haeger 1.8L stainless steel automatic electric rice cooker with food-grade steamer basket, tempered glass lid, and keep-warm function.', 3500.00, 50, 'assets/trends/rice_cooker.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(77, 4, 1, 'Pyle Vintage Classic Rotary Dial Telephone Set', 'Classic retro rotary dial landline telephone in glossy black finish with coiled handset cord and authentic bell ringer.', 2700.00, 40, 'assets/trends/tele_sett.jpg', NULL, '2026-03-02 08:21:39', 5, 1000),
(122, 1, 32, 'Miyako 3-in-1 Electric Blender & Grinder', 'Miyako 3-in-1 multi-purpose electric blender with food grade blending jug, wet and dry grinder jars, and motor safety protection.', 450.00, 10, '/uploads/img_69ddf30fa3cf42.29250226.jpg', NULL, '2026-04-14 07:55:59', 5, 1000);
