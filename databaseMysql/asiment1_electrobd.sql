...
-- Procedures
--
CREATE DEFINER=`asiment1`@`localhost` PROCEDURE `sp_search_products` (IN `p_query` VARCHAR(255), IN `p_limit` INT, IN `p_offset` INT)   BEGIN
...
CREATE DEFINER=`asiment1`@`localhost` PROCEDURE `sp_stock_in` (IN `p_product_id` INT, IN `p_quantity` INT, IN `p_reference_type` VARCHAR(20), IN `p_reference_id` INT, IN `p_notes` TEXT, IN `p_created_by` INT)   BEGIN
...
CREATE DEFINER=`asiment1`@`localhost` PROCEDURE `sp_stock_out` (IN `p_product_id` INT, IN `p_quantity` INT, IN `p_reference_type` VARCHAR(20), IN `p_reference_id` INT, IN `p_notes` TEXT, IN `p_created_by` INT)   BEGIN
  DECLARE current_stock INT;
  DECLARE new_stock INT;
  SELECT stock_quantity INTO current_stock FROM products WHERE product_id = p_product_id;
...
(34, 'hero', '/uploads/img_69ecfaddd247c3.50953851.png', '', 'Pre-ramadan', '', '', 0, 1, NULL, NULL, '2026-04-25 17:33:31', '2026-04-25 17:33:31'),
(35, 'hero', '/uploads/img_69ecfaea67f035.17233764.png', '', 'Top Products', '', '', 1, 1, NULL, NULL, '2026-04-25 17:33:31', '2026-04-25 17:33:31');
...
(40, 591, '2026-03-05 08:00:00', 'Trusted rice cooker for consistent everyday cooking.', 'Perfect Rice for Every Meal', '2026-04-25 17:45:55'),
...
(28, 'ROZIA', 'assets/Brand Logo/images (7).png'),
(29, 'Miyoko', 'assets/Brand Logo/images.jpg'),
(31, 'E-BRANDS', 'assets/Brand Logo/images (2).jpg'),
(32, 'KINNEDE', 'assets/Brand Logo/images (3).jpg'),
...
(40, 'm m E', 'assets/Brand Logo/images (11).jpg');
...
(3, 'Happy', 'Doliiik', '2026-04-21 12:54:00', 0, 0, 0, 0, 1, '2026-04-17 06:54:40');
...
INSERT INTO `orders` (`order_id`, `user_id`, `total_amount`, `order_status`, `payment_method`, `payment_status`, `delivery_address`, `transaction_id`, `estimated_delivery`, `customer_name`, `customer_phone`, `order_date`) VALUES
(42, NULL, 2800.00, 'pending', 'Cash on Delivery', 'unpaid', 'badda,Dhaka', 'COD-1777139154273', '30 April 2026', 'Ahnaf', '01840658317', '2026-04-25 17:45:55');
...
(31, 42, 40, 'Prestige Rice Cooker 1.8L', 1, 2800.00, '', 'assets/bestSale/prestige.jpg');
...
(23, 24, 'aarnab222126@gmail.com', '1b425f32dae814e7eeab40ef732a2d0a5f3b498e2e58ad1c49322e5365117338', '891271', '2026-04-14 18:18:07', 1, '2026-04-14 17:18:07');
...
INSERT INTO `payment_methods` (`method_id`, `method_name`, `method_type`, `is_enabled`, `account_number`, `display_order`, `icon_url`, `created_at`) VALUES
(1, 'bKash', 'mobile_banking', 1, '', 1, 'assets/payments/baksh.png', '2026-04-14 23:40:32'),
(2, 'Nagad', 'mobile_banking', 1, '', 2, 'assets/payments/nagad.png', '2026-04-14 23:40:32'),
(3, 'Rocket', 'mobile_banking', 1, '', 3, 'assets/payments/rocket.png', '2026-04-14 23:40:32'),
(4, 'Upay', 'mobile_banking', 1, '', 4, 'assets/payments/upay.png', '2026-04-14 23:40:32'),
(5, 'Cash on Delivery', 'cash', 1, '', 5, '', '2026-04-14 23:40:32'),
(6, 'Visa', 'card', 0, '', 6, 'assets/payments/visa.png', '2026-04-14 23:40:32'),
(7, 'Mastercard', 'card', 0, '', 7, 'assets/payments/master.png', '2026-04-14 23:40:32');
...
(40, 1, 1, 'Prestige Rice Cooker 1.8L', 'Known for durability and perfectly cooked rice every time. Non-stick inner pot, keep-warm function. The perfect rice cooker for daily use.', 2800.00, 21, 'assets/bestSale/prestige.jpg', NULL, '2026-03-01 07:11:36', 5, 1000),
...
,`review_count` int(11)
,`rating_1_star` int(11)
,`rating_2_star` int(11)
,`rating_3_star` int(11)
,`rating_4_star` int(11)
,`rating_5_star` int(11)
...
(1, 'Philips', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(2, 'Walton', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(3, 'Samsung', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(4, 'LG', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(5, 'Sony', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(6, 'Gree', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(7, 'Jamuna', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(8, 'Panasonic', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(9, 'Singer', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(10, 'Vision', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(11, 'Sharp', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(12, 'Toshiba', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(13, 'Hitachi', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(14, 'Haier', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(15, 'Whirlpool', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(16, 'Electrolux', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(17, 'Bosch', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(18, 'Siemens', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(19, 'Midea', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(20, 'TCL', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(21, 'Hisense', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(22, 'Konka', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(23, 'Changhong', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(24, 'Skyworth', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(25, 'Videocon', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(26, 'Onida', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(27, 'BPL', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(28, 'Unknown', 'brand', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(29, 'Kitchen Appliances', 'category', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(30, 'Personal Care & Lifestyle', 'category', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(31, 'Home Comfort & Utility', 'category', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(32, 'Electronics & Gadgets', 'category', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(33, 'Wiring & Cables', 'category', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(34, 'Tools & Hardware', 'category', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(35, 'Personal Care', 'category', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(36, 'Home Appliances', 'category', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(37, 'Fan & Cooling', 'category', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(38, 'Miyako Curry Cooker 5.5L', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(39, 'Nima 2-in-1 Grinder 400W', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(40, 'Miyako Kettle 180 PS 1.8L', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(41, 'Sokany Hair Dryer HS-3820', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(42, 'Kennede Charger Fan 2912', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(43, 'Miyako Pink Panther Blender 750W', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(44, 'NOHA Hotel King Blender 1050W', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(45, 'AV Sandwich Maker 296', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(46, 'Miyako 25L Electric Oven', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(47, 'Samsung CCTV Camera', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(48, 'Walton Blender 3-in-1 Machine', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(49, 'Panasonic Cooker 5L', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(50, 'Jamuna Fan', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(51, 'Walton AC 1.5 Ton', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(52, 'Walton AC 2 Ton', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(53, 'Panasonic Mixer Grinder', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(54, 'Hikvision Air Purifier', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(55, 'P9 Max Bluetooth Headphones', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(56, 'LG Table Fan 16\"', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(57, 'Acer SB220Q bi 21.5 Inches Full HD Monitor', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(58, 'Intel Core i7 12th Gen Processor', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(59, 'ASUS ROG Strix G15 Gaming Laptop', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(60, 'Logitech MX Master 3 Wireless Mouse', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(61, 'Samsung T7 Portable SSD 1TB', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(62, 'Corsair K95 RGB Platinum Mechanical Gaming Keyboard', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(63, 'Razer DeathAdder V2 Pro Wireless Gaming Mouse', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(64, 'Dell UltraSharp U2723QE 27 Inch 4K Monitor', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(65, 'Kennede Charger Fan 2412', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(66, 'Kennede Charger Fan 2916', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(67, 'Kennede Charger Fan 2926', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(68, 'Kennede Charger Fan 2936S', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(69, 'Kennede Charger Fan 2956P', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(70, 'HK Defender Charger Fan 2914', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(71, 'HK Defender Charger Fan 2916', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(72, 'HK Defender Charger Fan 2916 Plus', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(73, 'Kennede Charger Fan 2912 (Deal Model)', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(74, 'AV Sandwich Maker 560', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(75, 'Scarlet Hand Mixer HE-133', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(76, 'Kennede Charger Fan 2912 Flash', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(77, 'Prestige Rice Cooker 1.8L', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(78, 'Smart LED Strip', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(79, 'AV Sandwich Maker', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(80, 'Hair Dryer Professional', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(81, 'Hair Dryer Compact', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(82, 'Hand Mixer', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(83, 'Iron Master', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(84, 'JY Mini Rice Cooker 1880', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(85, 'Kennede Charger Fan', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(86, 'LR2018 Blender', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(87, 'Miyoko Electric Kettle', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(88, 'Nima Grinder 400W', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(89, 'Pink Leather Iron', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(90, 'Scarlet Hand Mixer', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(91, 'WD Mini Fan', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(92, 'YG Mini Cooker 717', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(93, 'Air Fryer Digital', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(94, 'AV Multi Cooker', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(95, 'Blender Pro 2000', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(96, 'Electric Kettle', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(97, 'Charger Fan Portable', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(98, 'Electric Stove Single', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(99, 'Hand Blender 3-in-1', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(100, 'Head Massager Electric', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(101, 'Kennede Rechargeable Fan', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(102, 'Mini Cooker Compact', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(103, 'Mini Cooker Deluxe', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(104, 'Mini Hand Blender', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(105, 'Miyoko Oven 25L', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(106, 'Noha Hot King Cooker', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(107, 'Rice Cooker 1.8L', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(108, 'Hair Styling Tool', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
(109, 'miyoko', 'product', 0, '2026-04-14 16:26:16', 1, '2026-04-14 16:26:16'),
...
(201, 'miyoko Blender', 'product', 0, '2026-04-14 16:49:20', 1, '2026-04-14 16:49:20');
...
(1, 'currency', 'BDT', '2026-03-01 07:11:36'),
(2, 'delivery_charge_inside_dhaka', '100', '2026-04-14 17:01:13'),
(3, 'delivery_charge_outside_dhaka', '160', '2026-04-14 17:01:13'),
(4, 'section_filter_best_sellers', '{\"limit\": 10, \"sort\": \"sales_desc\"}', '2026-03-01 07:11:36'),
(5, 'section_filter_deals', '{\"limit\": 10, \"sort\": \"newest\"}', '2026-03-01 07:11:36'),
(6, 'section_filter_flash_sale', '{\"limit\": 10, \"sort\": \"newest\"}', '2026-03-01 07:11:36'),
(7, 'section_filter_tech_part', '{\"limit\": 10, \"sort\": \"display_order\"}', '2026-03-01 07:11:36'),
(8, 'section_filter_trending', '{\"limit\": 10, \"sort\": \"score_desc\"}', '2026-03-01 07:11:36'),
(9, 'site_email', 'info@electrocitybd.com', '2026-03-01 07:11:36'),
(10, 'site_name', 'ElectrocityBD', '2026-03-01 07:11:36'),
(11, 'site_phone', '+880 1234-567890', '2026-03-01 07:11:36'),
(12, 'tax_rate', '0.00', '2026-03-01 07:11:36');
...
(142, 40, 'OUT', 1, 22, 21, 'ADJUSTMENT', NULL, 'Auto-tracked: Stock changed from 22 to 21', NULL, '2026-04-25 17:45:55');
...
(52, 40, 1, NULL, 0, '2026-04-25 17:45:55', '2026-04-25 17:45:55', '2026-04-25 17:45:55');
...
(21, 'ahnaf', '', '2ahnaf@gmail.com', '$2y$10$xiUF1OOh/qN2dSz3suqTD.YdYFqdxkb1YbiZnUlsou8UWs69M3lfm', '', NULL, 'Male', 'customer', '2026-04-14 16:32:07'),
(22, 'Admin', 'ElectroZone', 'adminNoman@electrozonebd.com', '$2y$10$ibH5Y541jWWdW6Wh561s7.SFIACPV6XQfqBcBqtbeJWLQq8gU31Ue', '01700000001', NULL, 'Male', 'admin', '2026-04-14 16:42:26'),
(23, 'Super', 'Admin', 'superadmin_roz@electrozonebd.com', '$2y$10$UYdB9xioWU991AtbiC4bo./.vtrEJ3U6yF9oV19Jjjm9f1WsXparS', '01700000002', NULL, 'Male', 'admin', '2026-04-14 16:42:26'),
(24, 'Ahnaf', 'Wadud', 'aarnab222126@gmail.com', '$2y$10$1DVX2s0VH.RyFWcahwalQuAKXX.e1isxSQqGyWn3.aJd5ZlToBpOa', '01840658317', 'Badda,link road,dhaka, link road, Dhaka 1212', 'Male', 'customer', '2026-04-14 16:44:26');
...
(21, 'ahnaf', '', '', NULL, 'Male', '2026-04-14 16:32:07'),
(24, 'Ahnaf', 'Wadud', '01840658317', 'Badda,link road,dhaka, link road, Dhaka 1212', 'Male', '2026-04-14 16:53:16');
...
ALTER TABLE `discounts`
  ...
  ADD KEY `product_id` (`product_id`),
  ADD KEY `idx_product_date` (`product_id`,`valid_from`,`valid_to`);
...
--
ALTER TABLE `banners`
  MODIFY `banner_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `search_suggestions`
  MODIFY `suggestion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=203;
...
--
ALTER TABLE `stock_movements`
  MODIFY `movement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=143;

--
-- AUTO_INCREMENT for table `trending_products`
--
ALTER TABLE `trending_products`
  MODIFY `trending_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`asiment1`@`localhost` SQL SECURITY DEFINER VIEW `ratings`  AS SELECT `product_ratings`.`rating_id` AS `rating_id`, `product_ratings`.`product_id` AS `product_id`, `product_ratings`.`rating_avg` AS `rating_avg`, `product_ratings`.`review_count` AS `review_count`, `product_ratings`.`rating_1_star` AS `rating_1_star`, `product_ratings`.`rating_2_star` AS `rating_2_star`, `product_ratings`.`rating_3_star` AS `rating_3_star`, `product_ratings`.`rating_4_star` AS `rating_4_star`, `product_ratings`.`rating_5_star` AS `rating_5_star`, `product_ratings`.`created_at` AS `created_at`, `product_ratings`.`updated_at` AS `updated_at` FROM `product_ratings` ;
...
--
ALTER TABLE `product_sections`
  ADD CONSTRAINT `product_sections_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE;
